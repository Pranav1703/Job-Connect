...
export const postjob = asyncHandler(async (req, res, next) => {
    ...
    console.log(role);
    const { jobTitle, companyName, locType, state, city, MinSalary, MaxSalary, description } = req.body;
...
export const updateJob = asyncHandler(async (req, res, next) => {
    ...
    const { title, companyName, locationType, state, city, MinSalary, MaxSalary, description, expired } = req.body;
...
export const getMyJobs = asyncHandler(async (req, res, next) => {
    ...
    if (role === "Job Seeker") {
        return next(new Error("Job Seeker not allowed to access this resource."));
    }
